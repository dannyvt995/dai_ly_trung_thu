      ...
      <div>
        ...
        <div>
          ...
          <h2 className='text-center text-[#fd7e14] my-7 leading-10'>
            Chuyên Phân Phối Các Loại Bánh Trung Thu Givral - Brodard - Kinh Đô
            - Như Lan- Bibica-Casahana- taithong{' '}
          </h2>
          ...
          <div className='flex flex-col gap-3'>
            <p className='my-4 leading-9 text-justify'>
              ...
              nhiệm của quý khách hàng trong suốt 10 năm vừa qua. Một mùa trung
              thu nữa lại về, thay mặt toàn thể nhân viên công ty xin kính chúc
              quý khách hàng có một mùa trung thu đầm ấm và hạnh phúc.
            </p>
            <p className='my-4 text-justify'>
              Bánh trung thu CQ MART là đơn vị phân phối bánh trung thu hàng đầu
              tại TP HCM, là nhà phân phối trực tiếp cấp 1 của các hãng bánh
              danh tiếng hiện nay:{' '}
              <span className='text-[#ff0000]'>
                Givral, Brodard, Kinh Đô, Như Lan, Bibica, Taithong, Casahana.
              </span>{' '}
              Cty chúng tôi chuyên cung cấp bánh trung thu cho công ty, xí
              nghiệp và đại lý bán lẻ với chất lượng đảm bảo, giá cả cạnh tranh
              nhất. Quý Khách hàng có thể tham khảo nhiều nơi, nhưng hãy liên hệ
              với chúng tôi để được trải nghiệm dịch vụ 4 NHẤT:
            </p>
            <p className='text-sm'>
              ...
              hãng, đảm bảo chất lượng 100%, trực tiếp xuất xưởng từ nhà máy tới
              khách hàng.​
            </p>
            <p className='text-sm'>
              <span className='text-[#ff0000] font-medium'>
            ...
            <p className='text-sm'>
              ...
              Chúng tôi có dịch vụ giao hàng nhanh, đúng hẹn, miễn phí. Ngoài ra
              hỗ trợ giao hàng tân nơi tới các tỉnh, thành lân cận TP HCM.
            </p>
            <p className='text-sm'>
              <span className='text-[#ff0000] font-medium'>
                4. Dịch vụ tốt nhất
              </span>
              Tư vấn nhiệt tình, miễn phí. Xuất hóa đơn VAT theo yêu cầu. Hỗ trợ
              In logo doanh nghiệp miễn phí lên hộp bánh, túi xách. Quà tặng hấp
              dẫn cho người liên hệ đặt hàng.
            </p>
            <p className='text-sm'>
              Với đội ngũ nhân viên tư vấn tận tình, chu đáo. Chúng tôi tin chắc
              sẽ làm hài lòng quý khách về cung cách phục vụ cũng như chất lượng
              sản phẩm. Hãy liên hệ với chúng tôi ngay hôm nay để nhận được báo
              giá và chiết khấu tốt nhất.
            </p>
            <p>
              Để có chiết khấu tốt nhất và đầy đủ mã bánh, hãy liên hệ ngay với
              chúng tôi hôm nay.
            </p>
            <p>
            ...
            <p className='text-sm italic'>
              Bánh Trung Thu Kinh Đô – Givral –Brodard - Như Lan Chiết Khấu Cao,
              Giao Hàng Nhanh
            </p>
            <p><span className='uppercase font-medium'>BÁNH TRUNG THU CQMART</span>  Địa chỉ MUA BANH TRUNG THU 2024 UY TIN TP HO CHI MINH</p>
          </div>
        </div>
      </div>
    </MainSection>
